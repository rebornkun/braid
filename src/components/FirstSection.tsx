    ...
    <section className="h-screen 3xl:h-[80vh] w-full relative">
      ...
      <div className="container mx-auto relative px-[20px] h-full">
        <div className="w-full h-full flex flex-col justify-center gap-[1rem] relative">
          <div className="w-[200px] h-[200px] rounded-full bg-[#044e4f] blur-[70px] absolute top-[150px] right-0"></div>
          <div className="w-[200px] h-[200px] rounded-full bg-[#044e4f] blur-[70px] absolute bottom-[-100px] right-[200px]"></div>
          <h1 className="MainFont text-[100%] 2xl:text-[20rem] w-fit font-[500] text-[18vw] leading-[1] text-[#383838DF] ">
            New Fashion.
          </h1>
          ...
          <div className="group/button w-fit h-[56px] bg-green text-[#f0e8e8] py-[15px] px-[25px] cursor-pointer  text-[12px] 2xl:text-[16px] font-[400] leading-[0.5] transition-all ease-in-out hairOne-300 shadow-[3px_3px_rgba(0,0,0,0.9)] hover:shadow-[5px_5px_rgba(0,0,0,0.9)] flex items-center justify-center gap-[5px]">
            Shop Now
            <div className="w-[0px] h-[0px] group-hover/button:h-[20px] group-hover/button:w-[20px] overflow-hidden transition-all ease-in-out hairOne-300">
